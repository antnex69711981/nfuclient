Ext.define('antnex.view.src.projectdetail.ProjectdetailController', {
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-projectdetail-funcbar-search');
            me.funcbarAdd = me.lookupReference('btn-projectdetail-funcbar-add');
            me.funcbarEdit = me.lookupReference('btn-projectdetail-funcbar-edit');
            me.funcbarSave = me.lookupReference('btn-projectdetail-funcbar-save');
            me.funcbarCancel = me.lookupReference('btn-projectdetail-funcbar-cancel');

            // 查詢列
            me.searchBar = me.lookupReference('panel-projectdetail-searchbar');
            me.searchCode = me.lookupReference('txt-projectdetail-searchbar-code');
            me.searchName = me.lookupReference('txt-projectdetail-searchbar-name');
            me.searchStatus = me.lookupReference('cmbx-projectdetail-searchbar-status');
            me.searchDatetype = me.lookupReference('cmbx-projectdetail-searchbar-datetype');
            // 主畫面
            me.viewprojectdetaillist = me.lookupReference('grid-projectdetail-projectdetaillist');
            me.viewprojectdetailManage = me.lookupReference('panel-projectdetail-manage');
            //資料維護
            me.viewIds = me.lookupReference('num-projectdetail-ids')
            me.viewCode = me.lookupReference('txt-projectdetail-code');
            me.viewName = me.lookupReference('txt-projectdetail-name');
            me.viewMail = me.lookupReference('txt-projectdetail-mail');
            me.viewPassword = me.lookupReference('txt-projectdetail-password')
            me.viewMemo = me.lookupReference('txt-projectdetail-memo');
            me.viewStatus = me.lookupReference('cmbx-projectdetail-status');
            me.viewCreateprojectdetailcode = me.lookupReference('txt-projectdetail-createprojectdetailcode');
            me.viewCreatetm = me.lookupReference('date-projectdetail-createtm');
            me.viewModifyprojectdetailcode = me.lookupReference('txt-projectdetail-modifyprojectdetailcode');
            me.viewModiftm = me.lookupReference('date-projectdetail-modiftm');

            //新增
            me.addbar = me.lookupReference('panel-projectdetail-addbar');
            me.addcode = me.lookupReference('txt-projectdetail-addbarcode');
            me.addname = me.lookupReference('txt-projectdetail-addbarname');
            me.addstatus = me.lookupReference('cmbx-projectdetail-addbarstatus');
            me.addmail = me.lookupReference('txt-projectdetail-addbarmail');
            me.addmemo = me.lookupReference('txt-projectdetail-addbarmemo');
            me.addcreateprojectdetailcode = me.lookupReference('txt-projectdetail-addbarcreateprojectdetailcode');
            me.addcreatetm = me.lookupReference('date-projectdetail-addbarcreatetm');
            me.addmodifyprojectdetailcode = me.lookupReference('txt-projectdetail-addbarmodifyprojectdetailcode');
            me.addmodiftm = me.lookupReference('date-projectdetail-addbarmodiftm');
        } catch (e) {
