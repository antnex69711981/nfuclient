Ext.define('antnex.view.src.dailyreport.DailyreportController', {
    ...
    onInitialize: async function () {
        const me = this;
        try {
            console.log(`dailyreportController/ onInitialize entry`);

            me.initObj();
            await me.refreshObj();
            me.initPageStatus();
        } catch (e) {
            me.showError(`dailyreportController/ onInitialize error: `, e);
        }
    },
    // event: 頁面切換
    onActivate: async function () {
        let me = this;
        try {
            console.log(`dailyreportController/ onActivate entry`);

        } catch (e) {
            me.showError(`dailyreportController/ onActivate error: `, e);
        }
    },
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-dailyreport-user-funcbar-search');
            me.funcbarPrint = me.lookupReference('btn-dailyreport-user-funcbar-print');
            // me.funcbarAdd = me.lookupReference('btn-dailyreport-user-funcbar-add');
            // me.funcbarEdit = me.lookupReference('btn-dailyreport-user-funcbar-edit');
            // me.funcbarSave = me.lookupReference('btn-dailyreport-user-funcbar-save');
            // me.funcbarCancel = me.lookupReference('btn-dailyreport-user-funcbar-cancel');

            // 查詢列
            me.searchBar = me.lookupReference('panel-dailyreport-user-searchbar');
            me.searchDate = me.lookupReference('date-dailyreport-user-searchbar-date');
            me.searchStore = me.lookupReference('cmbx-dailyreport-user-searchbar-store');

            // 主畫面
            me.viewUserlist = me.lookupReference('grid-dailyreport-user-userlist');
            // me.viewUserManage = me.lookupReference('panel-dailyreport-user-manage');

            // 資料維護
            // me.viewIds = me.lookupReference('num-dailyreport-user-ids');
            // me.viewCode = me.lookupReference('txt-dailyreport-user-code');
            // me.viewName = me.lookupReference('txt-dailyreport-user-name');
            // me.viewMail = me.lookupReference('txt-dailyreport-user-mail');
            // me.viewPassword = me.lookupReference('txt-dailyreport-user-password');
            // me.viewMemo = me.lookupReference('txt-dailyreport-user-memo');
            // me.viewStatus = me.lookupReference('cmbx-dailyreport-user-status');
            // me.viewCreateusercode = me.lookupReference('txt-dailyreport-user-createusercode');
            // me.viewCreatetm = me.lookupReference('txt-dailyreport-user-createtm');
            // me.viewModifyusercode = me.lookupReference('txt-dailyreport-user-modifyusercode');
            // me.viewModifytm = me.lookupReference('txt-dailyreport-user-modifytm');


        } catch (e) {
            me.showError('dailyreportController/ initObj error:', e);
        }
    },
    ...
    refreshObj: async function () {
        ...
        try {
            ...
            me.showError('dailyreportController/ refreshObj error:', e);
        }
    },
    ...
    initPageStatus: function () {
        ...
        try {
            ...
            me.showError('dailyreportController/ initPageStatus error:', e);
        }
    },
    ...
    //     } catch (e) {
    //         me.showError('dailyreportController/ disabledAll error:', e);
    //     }
    // },
    // // function: 更改狀態
    ...
    //         }
    //     } catch (e) {
    //         me.showError('dailyreportController/ changeStatus error:', e);
    //     }
    // },
    ...
    //     } catch (e) {
    //         me.showError('dailyreportController/ funcbar_search error:', e);
    //     }
    // },
    // // button: 新增
    ...
    //     } catch (e) {
    //         me.showError('dailyreportController/ funcbar_add error:', e);
    //     }
    // },
    // // button: 修改
    ...
    //         }
    //     } catch (e) {
    //         me.showError('dailyreportController/ enterSearch error:', e);
    //     }
    // },
    // // button: 查詢
    ...
    //         }
    //     } catch (e) {
    //         me.showError('dailyreportController/ doSearch error:', e);
    //     }
    // },
    // // button: 清除
    ...
    //         me.doSearch();
    //     } catch (e) {
    //         me.showError('dailyreportController/ cleanSearch error:', e);
    //     }
    // },
    ...
    //     } catch (e) {
    //         me.showError('dailyreportController/ onSelectUser error:', e);
    //     }
    // },
    // // function: 載入選擇的資料
    ...
    //         }
    //     } catch (e) {
    //         me.showError('dailyreportController/ loadData error:', e);
    //     }
    // },
