Ext.define('antnex.subsystem.11261133.user.userController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.page-11261133-user',
    requires: [],
    config: {
        name: '使用者管理1',
    },
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-11261133-user-funcbar-search');
            me.funcbarAdd = me.lookupReference('btn-11261133-user-funcbar-add');
            me.funcbarEdit = me.lookupReference('btn-11261133-user-funcbar-edit');
            me.funcbarSave = me.lookupReference('btn-11261133-user-funcbar-save');
            me.funcbarCancel = me.lookupReference('btn-11261133-user-funcbar-cancel');

            // 查詢列
            me.searchBar = me.lookupReference('panel-11261133-user-searchbar');
            me.searchCode = me.lookupReference('txt-11261133-user-searchbar-code');
            me.searchName = me.lookupReference('txt-11261133-user-searchbar-name');
            me.searchStatus = me.lookupReference('cmbx-11261133-user-searchbar-status');

            // 主畫面
            me.viewUserlist = me.lookupReference('grid-11261133-user-userlist');

            me.viewCode = me.lookupReference('txt-11261133-user-code');
            me.viewName = me.lookupReference('txt-11261133-user-name');
        } catch (e) {
