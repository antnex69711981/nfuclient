                ...
                items: [
                    {   // 基本資料
                        ...
                        items: [{
                            xtype: 'numberfield',
                            fieldLabel: 'ids',
                            reference: 'num-40941139-user-ids',
                            labelWidth: 37,
                            // cls: 'fieldNotInput',
                        }, {
                            xtype: 'textfield',
                            ...
                            xtype: 'textfield',
                            fieldLabel: '密碼',
                            reference: 'txt-40941139-user-password',
                            labelWidth: 37,
                            inputType: 'password',
                            cls: 'fieldRequired',
                        }, {
                            ...
                            xtype: 'textfield',
                            fieldLabel: '建立人員',
                            reference: 'txt-40941139-user-createusername',
                            //disabled: true,
                            // labelAlign: 'top',
                            labelWidth: 65,
                            // cls: 'fieldRequired',
                            ...
                            xtype: 'textfield',
                            fieldLabel: '建立時間',
                            reference: 'text-40941139-user-createtm',
                            // format: 'Y-m-d',
                            //disabled: true,
                            // labelAlign: 'top',
                            labelWidth: 65,
                            ...
                            xtype: 'textfield',
                            fieldLabel: '異動人員',
                            reference: 'txt-40941139-user-modifyusername',
                            //disabled: true,
                            // labelAlign: 'top',
                            labelWidth: 65,
                            // cls: 'fieldRequired',
                            ...
                            xtype: 'textfield',
                            fieldLabel: '異動時間',
                            reference: 'text-40941139-user-modifytm',
                            // format: 'Y-m-d',
                            //disabled: true,
                            // labelAlign: 'top',
                            labelWidth: 65,
                        ...
                        items: [{
                                xtype: 'button',
                                text: '儲存',
                                reference: 'btn-40941139-user-save',
                                scale: 'small',
                                cls: 'antBtn-blue',
                                iconCls: 'fa fa-save',
                                // hidden:true,
                                ...
                                xtype: 'button',
                                text: '修改',
                                reference: 'btn-40941139-user-edit',
                                scale: 'small',
                                cls: 'antBtn-yellow',
                                iconCls: 'fa fa-edit',
                                // hidden:true,
                                ...
                                xtype: 'button',
                                text: '取消',
                                reference: 'btn-40941139-user-cancel',
                                scale: 'small',
                                cls: 'antBtn-red',
                                // iconCls: 'fa fa-times',
                                // hidden:true,
                                ...
                                xtype: 'button',
                                text: '新增',
                                reference: 'btn-40941139-user-add',
                                scale: 'small',
                                cls: 'antBtn-green',
                                iconCls: 'fa fa-plus',
                                // hidden:true,
