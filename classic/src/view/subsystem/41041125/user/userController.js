Ext.define('antnex.subsystem.41041125.user.userController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.page-41041125-user',
    requires: [],
    config: {
        name: '使用者管理1',
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-page-41041125-user-funcbar-search');
            me.funcbarAdd = me.lookupReference('btn-page-41041125-user-funcbar-add');
            me.funcbarEdit = me.lookupReference('btn-page-41041125-user-funcbar-edit');
            me.funcbarSave = me.lookupReference('btn-page-41041125-user-funcbar-save');
            me.funcbarCancel = me.lookupReference('btn-page-41041125-user-funcbar-cancel');

            // 查詢列
            me.searchBar = me.lookupReference('panel-page-41041125-user-searchbar');
            me.searchCode = me.lookupReference('txt-page-41041125-user-searchbar-code');
            me.searchName = me.lookupReference('txt-page-41041125-user-searchbar-name');
            me.searchStatus = me.lookupReference('cmbx-page-41041125-user-searchbar-status');

            // 主畫面
            me.viewUserlist = me.lookupReference('grid-page-41041125-user-userlist');
            me.viewUserManage = me.lookupReference('panel-page-41041125-user-manage');

            // 資料維護
            me.viewIds = me.lookupReference('num-page-41041125-user-ids');
            me.viewCode = me.lookupReference('txt-page-41041125-user-code');
            me.viewName = me.lookupReference('txt-page-41041125-user-name');
            me.viewMail = me.lookupReference('txt-page-41041125-user-mail');
            me.viewPassword = me.lookupReference('txt-page-41041125-user-password');
            me.viewStatus = me.lookupReference('cmbx-page-41041125-user-status');
            me.viewMemo = me.lookupReference('txt-page-41041125-user-memo');
        } catch (e) {
