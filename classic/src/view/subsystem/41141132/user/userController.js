Ext.define('antnex.subsystem.41141132.user.userController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.page-41141132-user',
    requires: [],
    config: {
        name: '使用者管理1',
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-41141132-user-funcbar-search');
            me.funcbarAdd = me.lookupReference('btn-41141132-user-funcbar-add');
            me.funcbarEdit = me.lookupReference('btn-41141132-user-funcbar-edit');
            me.funcbarSave = me.lookupReference('btn-41141132-user-funcbar-save');
            me.funcbarCancel = me.lookupReference('btn-41141132-user-funcbar-cancel');
            me.funcbarDate = me.lookupReference('btn-41141132-user-funcbar-Date');
            // 查詢列
            me.searchBar = me.lookupReference('panel-41141132-user-searchbar');
            me.searchCode = me.lookupReference('txt-41141132-user-searchbar-code');
            me.searchName = me.lookupReference('txt-41141132-user-searchbar-name');
            me.searchStatus = me.lookupReference('cmbx-41141132-user-searchbar-status');

            // 主畫面
            me.viewUserlist = me.lookupReference('grid-41141132-user-userlist');
            me.viewUserManage = me.lookupReference('panel-41141132-user-manage');

            // 資料維護
            me.viewIds = me.lookupReference('num-41141132-user-ids');
            me.viewCode = me.lookupReference('txt-41141132-user-code');
            me.viewName = me.lookupReference('txt-41141132-user-name');
            me.viewMail = me.lookupReference('txt-41141132-user-mail');
            me.viewPassword = me.lookupReference('txt-41141132-user-password');
            me.viewStatus = me.lookupReference('cmbx-41141132-user-status');
            me.viewMemo = me.lookupReference('txt-41141132-user-memo');
            me.viewCreateusercode = me.lookupReference('txt-41141132-user-createusercode');
            me.viewCreatetm = me.lookupReference('txt-41141132-user-createtm');
            me.viewModifyusercode = me.lookupReference('txt-41141132-user-modifyusercode');
            me.viewModifytm = me.lookupReference('txt-41141132-user-modifytm');
        } catch (e) {
    ...
    disabledAll: function () {
        ...
        try {
            ...
            me.viewCreateusercode.setReadOnly(true);
            me.viewCreatetm.setReadOnly(true);
            me.viewModifyusercode.setReadOnly(true);
    ...
    doSearch: async function () {
        ...
        try {
            ...
            //const modifyusercode = me.searchModifyusercode.getValue();
            //const createusercode = me.searchCreateusercode.getValue();
            //const createtm = me.searchCreatetm.getValue();
            //const modifytm = me.searchModifyusertm.getValue();
