Ext.define('antnex.subsystem.41041145.user.userController', {
    ...
    initObj: function () {
        ...
        try {
            // 功能列
            me.funcbarSearch = me.lookupReference('btn-page-41041145-user-funcbar-search');
            me.funcbarAdd = me.lookupReference('btn-page-41041145-user-funcbar-add');
            me.funcbarEdit = me.lookupReference('btn-page-41041145-user-funcbar-edit');
            me.funcbarSave = me.lookupReference('btn-page-41041145-user-funcbar-save');
            me.funcbarCancel = me.lookupReference('btn-page-41041145-user-funcbar-cancel');

            // 查詢列
            me.searchBar = me.lookupReference('panel-page-41041145-user-searchbar');
            me.searchCode = me.lookupReference('txt-page-41041145-user-searchbar-code');
            me.searchName = me.lookupReference('txt-page-41041145-user-searchbar-name');
            me.searchMail = me.lookupReference('txt-page-41041145-user-searchbar-mail');
            me.searchStatus = me.lookupReference('cmbx-page-41041145-user-searchbar-status');

            // 主畫面
            me.viewUserlist = me.lookupReference('grid-page-41041145-user-userlist');
            me.viewUserManage = me.lookupReference('panel-page-41041145-user-manage');

            // 資料維護
            me.viewIds = me.lookupReference('num-page-41041145-user-ids');
            me.viewCode = me.lookupReference('txt-page-41041145-user-code');
            me.viewName = me.lookupReference('txt-page-41041145-user-name');
            me.viewMail = me.lookupReference('txt-page-41041145-user-mail');
            me.viewPassword = me.lookupReference('txt-page-41041145-user-password');
            me.viewStatus = me.lookupReference('cmbx-page-41041145-user-status');
            me.viewMemo = me.lookupReference('txt-page-41041145-user-memo');
        } catch (e) {
