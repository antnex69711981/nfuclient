Ext.define('antnex.subsystem.41141114.user.user',{
    extend:'Ext.panel.Panel',
    requires:[
        'antnex.subsystem.41141114.user.userController',
    ],
    alias:'widget.page-41141114-user',
    controller:'page-41141114-user',
