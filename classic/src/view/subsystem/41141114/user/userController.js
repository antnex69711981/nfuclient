Ext.define('antnex.subsystem.41141114.user.userController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.page-41141114-user',
    requires: [],
    config: {
        name: '王彥雄-使用者管理',
    ...
    initObj: function () {
        ...
        try {
            ...
            // me.funcbarMail = me.lookupReference('btn-antStanley-user-funcbar-mail');
            // me.funcbarMemo = me.lookupReference('btn-antStanley-user-funcbar-memo');
            // me.funcbarCreateusercode = me.lookupReference('btn-antStanley-user-funcbar-createusercode');
            // me.funcbarCreatetm = me.lookupReference('btn-antStanley-user-funcbar-createtm');
            // me.funcbarModifyusercode = me.lookupReference('btn-antStanley-user-funcbar-modifyusercode');
            // me.funcbarModifytm = me.lookupReference('btn-antStanley-user-funcbar-modifytm');
            ...
            me.searchMail = me.lookupReference('txt-antStanley-user-searchbar-mail');
            me.searchStatus = me.lookupReference('cmbx-antStanley-user-searchbar-status');
            // me.searchMemo = me.lookupReference('txt-antStanley-user-funcbar-memo');
            // me.searchCreateusercode = me.lookupReference('txt-antStanley-user-funcbar-createusercode');
            // me.searchcreatetm = me.lookupReference('txt-antStanley-user-funcbar-createtm');
            // me.searchModifyusercode = me.lookupReference('txt-antStanley-user-funcbar-Modifyusercode');
            // me.searchModifytm = me.lookupReference('txt-antStanley-user-funcbar-Modifytm');
            ...
            me.viewCreateusercode = me.lookupReference('txt-antStanley-user-createusercode');
            me.viewCreatetm = me.lookupReference('txt-antStanley-user-createtm');
            me.viewModifyusercode = me.lookupReference('txt-antStanley-user-modifyusercode');
            me.viewModifytm = me.lookupReference('txt-antStanley-user-modifytm');
