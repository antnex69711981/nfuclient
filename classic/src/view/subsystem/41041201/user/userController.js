Ext.define('antnex.subsystem.41041201.user.userController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.page-41041201-user',
    requires: [],
    config: {
        name: '使用者管理1',
    },
    ...
    refreshObj: async function () {
        ...
        try {
            let data = [{
                ...
                code: '41041201',
                name: '吳怡臻',
                mail: '41041201@gm.nfu.edu.tw',
                memo: '',
                status: 1,
                createusercode: '41041201',
                createtm: '2023/11/14',
                modifyusercode: '41041202',
                modifytm: '2023/11/15',
            }]
