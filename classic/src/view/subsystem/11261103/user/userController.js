Ext.define('antnex.subsystem.11261103.user.userController', {
    ...
    initObj: function () {
        ...
        try {
            ...
            me.viewUserManage = me.lookupReference('panel-11261103-user-manage');
            //資料維護
            me.viewIds = me.lookupReference('num-11261103-user-ids')
            ...
            me.viewPassword = me.lookupReference('txt-11261103-user-password')
            ...
            switch (me.getConfig('action')) {
                case 'view':
                    ...
                    case 'add':
                        ...
                        me.viewStatus.setReadOnly(false);
                        me.viewMemo.setReadOnly(false);
                        me.viewCreateusercode.setReadOnly(false);
                        me.viewCreatetm.setReadOnly(false);
                        me.viewModifyusercode.setReadOnly(false);
