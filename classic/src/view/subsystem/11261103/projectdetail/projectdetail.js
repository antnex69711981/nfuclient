Ext.define('antnex.subsystem.11261103.projectdetail.projectdetail', {
    extend: 'Ext.panel.Panel',
    requires: [
        'antnex.subsystem.11261103.projectdetail.projectdetailController',
    ],
    ...
    dockedItems: [{
        ...
        items: [
                ...
                items: [
                    {
                        xtype: 'funcbarButton',
                        text: '查詢列',
                        reference: 'btn-11261103-projectdetail-funcbar-search',
                    ...
                    { xtype: 'tbseparator', margin: '8 1' },
                    {
                        xtype: 'funcbarButton',
                        text: '匯出',
                        reference: 'btn-11261103-projectdetail-funcbar-export',
                        cls: 'funcbarBtn-black',
                    ...
                    { xtype: 'tbseparator', margin: '8 1' },
                    {
                        xtype: 'funcbarButton',
                        text: '儲存',
                        reference: 'btn-11261103-projectdetail-funcbar-save',
                        cls: 'funcbarBtn-black',
                        iconCls: 'fa fa-save',
                        margin: 3,
                    ...
                    },
                    {
                        xtype: 'funcbarButton',
                        text: '取消',
                        reference: 'btn-11261103-projectdetail-funcbar-cancel',
                        cls: 'funcbarBtn-black',
                        iconCls: 'fa fa-times',
                        margin: 3,
            ...
            {   // 查詢列
                xtype: 'panel',
                reference: 'panel-11261103-projectdetail-searchbar',
                layout: {
                    type: 'hbox',
                    align: 'stretch',
                },
                ...
                items: [
                    {   // 查詢條件
                        ...
                        {//日期類型
                            xtype: 'antCombobox',
                            fieldLabel: '日期類型',
                            reference: 'cmbx-11261103-projectdetail-searchbar-datetype',
                            valueField: 'value',
                            displayField: 'text',
                            queryMode: 'local',
                            forceSelection: true,
                            ...
                            xtype: 'antDatefield',
                            fieldLabel: '開始日期',
                            reference: 'date-11261103-projectdetail-searchbar-startdate',
                            //emptyText: '請輸入姓名',
                            margin: '0 10 8 5',
                            margin: '0 0 8 0',
                            enableKeyEvents: true,
                            ...
                            xtype: 'antDatefield',
                            fieldLabel: '結束日期',
                            reference: 'date-11261103-projectdetail-searchbar-enddate',
                            //emptyText: '請輸入姓名',
                            margin: '0 10 8 5',
                            margin: '0 0 8 0',
                            enableKeyEvents: true,
                           // flex:1,
                            ...
                            xtype: 'antTagfield',
                            fieldLabel: '電信商',
                            reference: 'tag-11261103-projectdetail-searchbar-tele',
                            store: {
                                data:[
                                    {id: 0, show: 'A'},
                                    {id: 1, show: 'B'},
                            ...
                            xtype: 'antTagfield',
                            fieldLabel: '盤商',
                            reference: 'tag-11261103-projectdetail-searchbar-dealer',
                        ...
                        /*{
                            xtype: 'combobox',
                            fieldLabel: '狀　　態',
                            reference: 'cmbx-11261103-projectdetail-searchbar-status',
                        ...
                        items:[
                            {//門市、銷售員查詢
                                ...
                                items: [
                                    { // 門市查詢
                                    xtype: 'panel',
                                    //reference: 'panel-11261103-projectdetail-addbar',
                                    layout: {
                                        type: 'hbox',
                                        align: 'stretch',
                                    },
                                    ...
                                    items:[ {
                                        ...
                                        reference: 'tag-11261103-projectdetail-searchbar-store',
                                        store: {},
                                        // displayField: 'show',
                                        // valueField: 'id',
                                        // queryMode: 'local',
                                    ...
                                    items:[ {
                                        xtype: 'antTagfield',
                                        //fieldLabel: '電信商',
                                        reference: 'tag-11261103-projectdetail-searchbar-employee',
                                        store: {},
                                        // displayField: 'show',
                                        // valueField: 'id',
                                        // queryMode: 'local',
                                ...
                                items: [
                                    {
                                        ...
                                        reference: 'tag-11261103-projectdetail-searchbar-ship',
                                        store: {},
                                        // displayField: 'show',
                                        // valueField: 'id',
                                        // queryMode: 'local',
    ...
    items: [{//專案銷售明細表
        ...
        items: [
                ...
                items:[
                    {
                        xtype: 'antCombobox',
                        fieldLabel: '專案類型:',
                        reference: 'cmbx-11261103-projectdetail-panel-type',
                       ...
                       // margin: '8 5 8 5',
                        ...
                        xtype: 'antTextfield',
                        fieldLabel: '關鍵字:',
                        reference: 'txt-11261103-projectdetail-panel-keyword',
                        enableKeyEvents: true,
                        listeners: {
                            keypress: 'enterSearch'
                        },
                    ...
                    },
                    {
                        xtype: 'antTextfield',
                        //fieldLabel: '關鍵字:',
                        reference: 'txt-11261103-projectdetail-panel-textfield',
                        enableKeyEvents: true,
                        listeners: {
                            keypress: 'enterSearch'
                        },
                    ...
                    },
                    {
                        xtype: 'antButton',
                        text: '批次修改',
                        reference: 'btn-11261103-projectdetail-btn-edit',
                        scale: 'small',
                        cls: 'antBtn-blue',
                        //margin: 3,
                        //handler: 'funcbar_save',
            ...
            {   // 使用者清單
                xtype: 'antGridpanel',
                //title: '使用者清單',
                reference: 'grid-11261103-projectdetail-projectdetaillist',
