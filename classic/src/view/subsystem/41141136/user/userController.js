Ext.define('antnex.subsystem.41141136.user.userController', {
    ...
    initObj: function () {
        ...
        try {
            ...
            me.viewUserManage = me.lookupReference('panel-41141136-user-manage');

            me.viewIds = me.lookupReference('num-41141136-user-ids');
            ...
            me.viewPassword = me.lookupReference('txt-41141136-user-password');
            me.viewStatus = me.lookupReference('cmbx-41141136-user-status');
    ...
    doSearch: async function () {
        ...
        try {
            ...
            const modifytm = me.searchmodifytm.getValue();
